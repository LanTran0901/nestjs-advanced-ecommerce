...
-- CreateIndex
CREATE UNIQUE INDEX "Permission_path_method_key" ON "public"."Permission"("path", "method");
...
-- AddForeignKey
ALTER TABLE "public"."Order" ADD CONSTRAINT "Order_paymentId_fkey" FOREIGN KEY ("paymentId") REFERENCES "public"."Payment"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
